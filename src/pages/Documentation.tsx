        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Learn how to integrate our content moderation API into your
              application
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      ...
                      header. You can manage your API keys in your
                      <a
                        href="/api-management"
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4">
                      Analyze text content for toxic, harmful, or inappropriate
                      content.
                    </p>
                    ...
                    <div className="rounded-md overflow-hidden border border-border mb-4">
                      <div className="bg-muted p-3 flex justify-between items-center">
                        ...
                        <span className="px-2 py-1 bg-green-500/10 text-green-500 text-xs rounded-md">
                          200 OK
                        </span>
                      </div>
                      <div className="p-4">
                            ...
                            {JSON.stringify(
                              {
                                ...
                                summary:
                                  "Content contains toxic and harassing language.",
                              },
                              null,
                              2
                            )}
            ...
            <TabsContent value="examples" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    See examples of how to integrate our API in different
                    languages
                  </CardDescription>
                </CardHeader>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      Each API response includes headers to help you monitor
                      your rate limit usage:
                    </p>

                    <div className="bg-muted p-4 rounded-md text-sm font-mono">
                      <pre>
                        X-RateLimit-Limit: 100000 X-RateLimit-Remaining: 99950
                        X-RateLimit-Reset: 1623790800
                      </pre>
                    </div>
                    ...
                    <div className="mt-4 space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        The number of requests remaining in the current rate
                        limit window.
                      </p>
                      <p className="text-sm text-muted-foreground">
                        <span className="font-semibold">
