...
type ModerationType = 'toxicity' | 'harassment' | 'hate-speech' | 'sexual' | 'violence' | 'spam';
...
const sampleRequests: ModerationRequest[] = [
  ...
  },
  {
    ...
    contentType: "text",
    content: "I disagree with your opinion on this matter. Let's discuss further.",
    flags: [
  ...
  },
  {
    ...
    status: "borderline",
    feedback: "Image is borderline inappropriate but not explicit enough to flag."
  },
  {
    id: "req_4567890123",
    timestamp: "2023-07-15T11:03:12Z",
    contentType: "text",
    content: "I hate all people from that country. They should all go back where they came from!",
    flags: [
  ...
  },
  {
    ...
    contentType: "text",
    content: "Don't miss this amazing opportunity! Click now to claim your prize: www.definitely-not-a-scam.com",
    flags: [
...
export default function ModerationRequests() {
  ...
  const filteredRequests = requests.filter(request => {
    ...
    return (
      ...
      request.flags.some(flag => flag.type.toLowerCase().includes(searchLower))
    );
  });
      ...
      <main className="flex-grow bg-muted/30 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div>
              <h1 className="text-2xl font-bold text-foreground">Moderation Requests</h1>
              <p className="text-muted-foreground">View and manage your content moderation requests</p>
            </div>
                            ...
                            <div className="flex gap-2">
                              <Dialog>
                                ...
                                <DialogContent className="max-w-3xl">
                                  <DialogHeader>
                                    <DialogTitle>
                                      {editMode ? "Edit Moderation Request" : "Moderation Request Details"}
                                    </DialogTitle>
                                    <DialogDescription>
                                  ...
                                  {currentRequest && (
                                    <div className="space-y-6 py-4">
                                      <div className="grid grid-cols-2 gap-4">
                                        <div>
                                          <Label className="text-muted-foreground text-sm">Timestamp</Label>
                                        ...
                                        <div>
                                          ...
                                          <div className="font-medium">
                                            {currentRequest.contentType === 'text' ? 'Text' : 'Image'}
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div>
                                        ...
                                        <div className="mt-1 p-3 bg-muted rounded-md">
                                          {currentRequest.contentType === 'text' ? (
                                            <p className="whitespace-pre-wrap">{currentRequest.content}</p>
                                          ) : (
                                      ...
                                      <div>
                                        ...
                                        <div className="space-y-4">
                                          {currentRequest.flags.map((flag, idx) => (
                                              ...
                                              <div className="flex items-center gap-2">
                                                {editMode ? (
                                                  <Checkbox
                                                    ...
                                                    onCheckedChange={() => toggleFlag(flag.type)}
                                                  />
                                                ) : flag.flagged ? (
                                                ...
                                                <Label htmlFor={`flag-${flag.type}`} className="cursor-pointer">
                                                  <ModerationBadge 
                                                    type={flag.type} 
                                                    showScore={false}
                                                  />
                                      ...
                                      <div>
                                        <Label htmlFor="feedback" className="text-muted-foreground text-sm">
                                          Feedback / Notes
                                        </Label>
                                        {editMode ? (
                                          <Textarea
                                          ...
                                          <div className="mt-1 p-3 bg-muted rounded-md min-h-[80px]">
                                            {currentRequest.feedback || (
                                              <span className="text-muted-foreground">No feedback provided</span>
                                            )}
                                          </div>
                                        )}
                                      </div>
